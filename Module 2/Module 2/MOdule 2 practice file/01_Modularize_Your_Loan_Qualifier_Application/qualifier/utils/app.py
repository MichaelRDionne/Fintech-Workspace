...
def filter_loan_to_value(loan_to_value_ratio, bank_list):
    ...
    for bank in bank_list:
        if loan_to_value_ratio_list <= int(bank[2]):
...
def run():
    ...
    file_path = "/Users/michaeldionne/Desktop/Fintech-Workspace/Module 2/MOdule 2 practice file/02_Loan_Qualifier_Filtering_Data/Solved/data/daily_rate_sheet.csv"
