    ...
    if risk_level is not None:
        if risk_level not in ["none", "low", "medium", "high"]:
            return build_validation_result(
                False,
                "riskLevel",
                "Invalid risk level, please choose between none, low, medium, or high.",
            )
    elif risk_level == "low":  
        return build_validation_result(
            True,
            "riskLevel",
            " I recommend investing into a portfolio of 60% bonds (AGG), 40% equities (SPY)."
        )
        ...
        return build_validation_result(
            True,
            "riskLevel",
            " I recommend investing into a portfolio of 100% bonds (AGG)."
        )         
