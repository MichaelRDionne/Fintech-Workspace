...
def get_applicant_info():
    """Ask for the applicant's financial information.
    ...
    income = questionary.text("What is your current income?").ask()
    loan_amount = questionary.text("What is your loan amount?").ask()
