...
avg_loan_price = sum_of_loans/number_of_loans
...
fair_value_loan = future_value / (1 + annual_discount_rate/12) ** remaining_months
print(f"The fair value of the loan is {fair_value_loan}.")
...
if fair_value_loan >= loan.get("loan_price"):
